...
joints = cmds.ls("aHumanSkeleton:hand_R", type='joint')
...
selectgeo = cmds.select('wWeapon_*', 'wSheathe_*')
...
for shape in cmds.ls(type='mesh'):
    ...
    if shape:
        ...
        if skinCluster:
            ...
            cmds.skinPercent(Clustername, shape, transformValue=[("aHumanSkeleton:hand_R", 1.0)])
